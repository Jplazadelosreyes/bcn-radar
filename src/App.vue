...
// Estado de la finca seleccionada (datos + derivados del dossier) en el store useFinca.
const {
...
// Radio de exploración desde la finca (círculo + paradas cercanas) en el store useRadio.
